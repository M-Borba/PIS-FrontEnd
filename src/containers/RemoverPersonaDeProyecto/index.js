...
function RemoverPersona({ personName, personId, projectName, projectId, handleClose, setNotify }) {
    ...
    const onConfirmation = () => {
        axiosInstance
            ...
            .then((response) => {
                ...
                let person = findPersonInPersonProjects(personId, response.data.person_project);
                if (person != undefined) {
                    ...
                    if (dates != undefined) {
                        ...
                        dates.forEach(assingment => {
                            axiosInstance
                                .delete("person_project/" + assingment)
                                .then((response) => {
                        ...
                        let message = "Error, parece que esa asignacion no existe, recargue la pagina e intente nuevamente";
                        setNotify({
                            isOpen: true,
                            message: message,
                            type: "error",
