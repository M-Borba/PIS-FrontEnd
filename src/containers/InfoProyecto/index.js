  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <Box mt={2}>
        ...
        <Typography variant="h6" display="inline" gutterBottom>Budget: </Typography>
      ...
      <Box mt={2}>
        ...
        <Typography variant="h6" display="inline" gutterBottom>Tipo proyecto: </Typography>
        <Typography display="inline" variant="body2">
      ...
      <Box mt={2}>
        ...
        <Typography variant="h6" display="inline" gutterBottom>Estado: </Typography>
        <Typography display="inline" variant="body2">
